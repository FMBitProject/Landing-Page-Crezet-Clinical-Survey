...
function SurveyForm({ onComplete, sessionPassword }) {
  ...
  function submitKonfirmasi(e) {
    ...
    const payload = {
      ...
      pahamVideo: '', // tetap dikirim kosong agar backend GS aman
        ...
        {step === 1 && (
          <div className="animate-fade-in">
            <div className="text-center mb-10">
              ...
              <p className="text-gray-500 text-lg">Silakan isi form ini setelah Anda mempelajari panduan.</p>
            </div>
              ...
              <div className="p-7 border-t border-gray-100 bg-gray-50">
                <div className="bg-amber-50 border border-amber-200 rounded-xl p-4 mb-5 flex items-start gap-3">
                  ...
                  <p className="text-sm text-amber-800">
                    <strong>Pastikan semua data sudah benar.</strong> Setelah disubmit, data akan tersimpan permanen di sistem dan tidak dapat diubah lagi.
                  </p>
                </div>
