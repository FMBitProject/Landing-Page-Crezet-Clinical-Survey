...
/* ══════════════════════════════════════════════════════════════════
   ContactSupport — UPDATED:
   - Hanya card WhatsApp yang clickable + ada tombol "Hubungi sekarang"
   - Card Email & Telepon: cuma display info, tidak clickable
   ══════════════════════════════════════════════════════════════════ */
   function ContactSupport() {
    const channels = [
      ...
      },
      {
        ...
        label: 'WhatsApp',
        value: '0878-7819-1986',
        href: 'https://wa.me/6287878191986?text=Halo%20Medical%20Affairs%20Daewoong%2C%20saya%20butuh%20bantuan%20terkait%20Survei%20Klinis%20Crezet',
      ...
      <section id="contact" className="py-24 bg-white">
        <div className="max-w-6xl mx-auto px-6">
          ...
          <div className="fade-in-up grid md:grid-cols-3 gap-6 mb-10">
            {channels.map((ch, i) => {
              // ─── WhatsApp: card sebagai link <a> dengan tombol Hubungi sekarang ───
              if (ch.isClickable) {
                return (
              ...
              // ─── Email & Telepon: cuma display, bukan link ───
              return (
